...
from Index_Builder_LlamaIndex import smart_index_loader
from SmolAgent_Implementation.prompt_loader import load_prompt
...
rag_agent= ToolCallingAgent(tools=[rag_tool],
                            model=rag_model,
                            name= "rag_agent",
                            description= "Tool that performs retrieval augemented generation from internal knowledge base")
